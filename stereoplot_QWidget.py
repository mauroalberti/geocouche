...
class SourcePointLayerDialog( QDialog ):
    ...
    def setup_gui(self):
        ...
        self.input_plane_orient_azimuth_type_QComboBox.addItems(stereoplot_QWidget.input_plane_azimuth_types)
        ...
        self.input_plane_orient_dip_type_QComboBox.addItems(stereoplot_QWidget.input_plane_dip_types)
        ...
        self.input_line_orient_azimuth_type_QComboBox.addItems(stereoplot_QWidget.input_line_azimuth_types)
        ...
        self.input_line_orient_dip_type_QComboBox.addItems(stereoplot_QWidget.input_line_dip_types)
